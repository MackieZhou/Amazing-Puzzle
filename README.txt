...
2. A python package, pygame, needs to be installed.
   See pygame official website(https://www.pygame.org/wiki/GettingStarted#Pygame%20Installation) to learn how to pip install pygame.
...
4. Everything will be clear when you try it out!
